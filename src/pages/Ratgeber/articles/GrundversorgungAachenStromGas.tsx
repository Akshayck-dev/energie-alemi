...
export default function GrundversorgungAachenStromGas() {
  ...
  const faqs = [
    {
      ...
      answer: "Ja. Wenn Sie in eine Wohnung oder ein Haus in Aachen einziehen und Strom oder Gas verbrauchen (z. B. durch Einschalten des Lichts), ohne vorher einen eigenen Vertrag abgeschlossen zu haben, kommt der Grundversorgungsvertrag automatisch durch die Entnahme von Energie zustande. Das ist gesetzlich in § 36 Abs. 1 des Energiewirtschaftsgesetzes (EnWG) geregelt."
    },
    {
  ...
  return (
    <ArticleLayout article={article} faqs={faqs}>
      ...
      <h2>Wer ist Grundversorger in Aachen?</h2>
      <p>
      ...
      <p>
        Für das Stadtgebiet Aachen ist die <strong>STAWAG (Stadt- und Städteregionswerke Aachen AG)</strong> der festgestellte Grundversorger für Strom und Gas. Der zuständige Netzbetreiber, der die Netzinfrastruktur verwaltet und Störungen behebt, ist die <strong>Regionetz GmbH</strong>, ein Tochterunternehmen der STAWAG.
      </p>
      <p>
